...
class ProfileForm1VC: BaseViewController {
    ...
    // MARK:- VARIABLES
    // var selectedValue = ""
    var arrayOptions = ["My Self", "Others"]
    ...
    override func setupUI() {
        ...
        if ProfileFormModel.shared.profileType.trim.count > 0 {
            if arrayOptions.contains(ProfileFormModel.shared.profileType) {
    ...
    override func goNext() {
        ...
        parameters["profileType"] = ProfileFormModel.shared.profileType
...
extension ProfileForm1VC : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if optionValue == ProfileFormModel.shared.profileType {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ProfileFormModel.shared.profileType = arrayOptions[indexPath.row]
        self.setupUI()

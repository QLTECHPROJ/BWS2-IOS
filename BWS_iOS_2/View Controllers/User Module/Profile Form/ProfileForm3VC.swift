...
class ProfileForm3VC: BaseViewController {
    ...
    override func goNext() {
        ...
        parameters["genderX"] = ProfileFormModel.shared.genderX
...
extension ProfileForm3VC : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if optionValue == ProfileFormModel.shared.genderX {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ProfileFormModel.shared.genderX = arrayOptions[indexPath.row]
        self.setupUI()
